 ...
 * 
 * @Override static void type method public static void sister(int age1, int
 * age6, double age3) { int total3 = age1 + age6 + (int) age3;
 * System.out.println("Total age of sister" + total3);
 * 
 * @Override static return type parameterized method public static int
 * sister(int age2, int age5, int age6) { int total4 = age2 + age5 + age6;
 * System.out.println("Total age of sister" + total4); return total4; those two
 * are final method final method can't be override
 * 
 * @Override final void type parameterized method public final void sister(int
 * age3, int age5) { int total5 = age3 + age5;
 * System.out.println("Total age of sister" + total5); }
 * 
 * @Override final return type parameterized method public final int sister(int
 * age6, String age4) { int total6 = age6 + Integer.parseInt(age4); return
 * total6;
 */